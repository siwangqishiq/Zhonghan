...
public class ColleageMsgDetail extends Fragment {
	public static final String TAG = "colleage_msg_detail";
	...
	public static ColleageMsgDetail newInstance(String url) {
		ColleageMsgDetail fragment = new ColleageMsgDetail();
		fragment.url = url;
		return fragment;
	}
	...
	private class BackOnClick implements OnClickListener {
		...
		public void onClick(View v) {
			...
			fm.popBackStack(ColleageFragment.TAG, 1);
		}
	}
