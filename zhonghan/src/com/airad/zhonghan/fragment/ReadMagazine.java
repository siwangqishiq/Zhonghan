...
public class ReadMagazine extends Fragment {
	public static final String TAG = "read_magazine";
	...
	public static ReadMagazine newInstance(String url) {
		ReadMagazine fragment = new ReadMagazine();
		fragment.url = url;
		return fragment;
	}
	...
	private class BackOnClick implements OnClickListener {
		...
		public void onClick(View v) {
			...
			fm.popBackStack(MagazineDetail.TAG, 1);
		}
	}
